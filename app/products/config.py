...
class Branding:
    ...
    Attributes:
        logo_text: Text displayed as logo (e.g., "Tool Tracker")
...
class Product:
    ...
    present as separate apps to users. Examples: Tool Tracker, AI Audio, Letter+

    Attributes:
        id: Unique identifier (e.g., "ai_toolkit")
        name: Display name (e.g., "Tool Tracker")
